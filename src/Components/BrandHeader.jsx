      ...
      "
        ...
        >
            ...
            "
                    ...
                    {/* Dropdown menu — sits directly below the title button */}
                    {dropdownOpen && (
                        <div
                            role="listbox"
                            className="absolute left-1/2 -translate-x-1/2 z-200 w-80 rounded-2xl overflow-hidden"
                            style={{
                                top: '100%',
                                marginTop: '16px',
